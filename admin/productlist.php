              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table tablesorter " id="page1">
                	...
                	<a class=" btn btn-primary" href="edit_product.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <form style='margin-bottom: 3px;' action='code.php' method='post'>
                        <input type='hidden' name='delete_id' value='$product_id'>
                        <button class='btn btn-success' name='delete_btn' >DELETE</button>
                        </form>

                        <form action='addproduct.php' method='post'>
                        <input type='hidden' name='edit_id' value='$product_id'>
                        <button class='btn btn-success' name='edit_btn' >UPDATE</button>
                        </form>
                        </td></tr>";
                        }
